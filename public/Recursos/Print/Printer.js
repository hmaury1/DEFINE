    ...
    statics: {
        ...
        print: function(grid) {
            ...
            var htmlMarkup = [
                ...
                '<html class="ux-grid-printer">',
                  '<head>',
                    '<meta content="text/html; charset=UTF-8" http-equiv="Content-Type" />',
                     '<link href="../../Recursos/Print/gridPrinterCss/print.css" rel="stylesheet" type="text/css" />',
                    '<title>' + grid.title + '</title>',
                  '</head>',
                  '<body class="ux-grid-printer-body">',
                  '<div class="ux-grid-printer-noprint ux-grid-printer-links">',
                      '<a class="ux-grid-printer-linkprint" href="javascript:void(0);" onclick="window.print();">' + this.printLinkText + '</a>',
                      '<a class="ux-grid-printer-linkclose" href="javascript:void(0);" onclick="window.close();">' + this.closeLinkText + '</a>',
                  '</div>',
